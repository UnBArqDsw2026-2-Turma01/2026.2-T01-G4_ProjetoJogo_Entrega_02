...
<span style="color: red;">Foram utilizados para versões iniciais dos diagramas do Subgrupo 1, porém, depois demos preferência aos requisitos do Subgrupo 3 por serem o grupo que propôs a ideia do jogo e portanto ficaram mais refinados.</span>
